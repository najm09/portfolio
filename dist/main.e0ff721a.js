...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"projects/Todo_App/main.js":[function(require,module,exports) {
"use strict";
...
var input = document.getElementById('user-todo'); // declare variable 'todosArray' to our todos.
...
localStorage.setItem('todos', JSON.stringify(todosArray)); // Declare a variable storage that contains all the information in local storage .
...
form.addEventListener('submit', function (e) {
  e.preventDefault(); //push onto 'todosArray' the 'input.value'

  todosArray.push(input.value); //on the localStorage now use 'setItem()' for the key 'todos' the value
...
var todoMaker = function todoMaker(text) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","projects/Todo_App/main.js"], null)
//# sourceMappingURL=/main.e0ff721a.js.map